...
public class PO_NavView extends PO_View {
	...
	public static void clickOption(WebDriver driver, String textOption, String criterio, String textoDestino) {
		...
		elementos = com.uniovi.util.SeleniumUtils.EsperaCargaPagina(driver, criterio, textoDestino, getTimeout()); // elemento.
	...
	public static void changeIdiom(WebDriver driver, String textLanguage) {
		...
		elementos = SeleniumUtils.EsperaCargaPagina(driver, "id", "languageDropdownMenuButton", getTimeout()); // SeleniumUtils.esperarSegundos(driver,
																												// 2);
